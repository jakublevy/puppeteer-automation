...
%	\paragraph{Formulář}
	\begin{figure}[H]
		...
		\captionsetup{justification=centering}
		\caption[Formulář CodeGenEditor s~komponentou\newline \texttt{ScintillaNET.Scintilla}]{Formulář CodeGenEditor s~komponentou \texttt{ScintillaNET.Scintilla}}
	\end{figure}
	\paragraph{Třídy}
...
%	\paragraph{Formulář}
	...
	\begin{figure}[H]
		...
		\captionsetup{justification=centering}
		\caption[Formulář RecorderSettingsForm s~uživatelskou komponentou\newline\texttt{PuppeteerOptionsUserControl}]{Formulář RecorderSettingsForm s~uživatelskou komponentou \texttt{PuppeteerOptionsUserControl}}
	\end{figure}
	\paragraph{Třidy}
...
%	\paragraph{Formulář}
	...
	\begin{figure}[H]
		...
		\caption{Uživatelská komponenta PuppeteerOptionsUserControl}
	\end{figure}
	\paragraph{Třídy}
	...
	\begin{figure}[H]
		...
		\captionsetup{justification=centering}
		\caption{Uživatelská komponenta ThumbnailUserControl zobrazující náhled nahrávky s~názvem "Webik" provedenou na stránce \href{https://webik.ms.mff.cuni.cz}{\nolinkurl{webik.ms.mff.cuni.cz}}}
	\end{figure}
	\paragraph{Třídy}
