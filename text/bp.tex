...
(async () => {
	...
	Později ve~\ref{sub_sec:PuppeteerUsageForAutomation} se zaměříme výhradně na Puppeteer, zde provedeme detailní rozbor možností Puppeteeru pro nahrávání a~přehrávání akcí včetně ukázek kódu demonstrující využití.
