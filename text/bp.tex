...
%	\end{longtable}
	...
	Hlavní nevýhodou, částečně vyplývající z~již zmíněných výhod, je omezená funkcionalita selenia API podporující pouze to, co umí všechny prohlížeče resp. všechny browser drivery.
